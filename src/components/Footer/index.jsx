  ...
  return (
    <footer>
        ...
        <div className="grid lg:grid-cols-3 xl:grid-cols-4">
          <div className="p-6 xl:flex md:justify-between xl:border-r border-lightgray">
            ...
            <ul>
              ...
              <li className='mb-4'>
                <a href="https://joeyscoin.vercel.app" className='text-gray hover:text-primary'>NFT</a>
              </li>
            </ul>
          </div>
      ...
      <div className="text-center py-6">
        <p className="text-gray">© Copyright 2024 TraderJoey LLC. All rights reserved</p>
      </div>
    </footer>
  );
}
